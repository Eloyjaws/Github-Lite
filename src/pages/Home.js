    ...
    return (
      <div className="container mt-5">
        <div className="jumbotron">
            <h1 className="display-3 text-center text-md-left">Hello!</h1>
            ...
            <p className="lead text-center">
                <button onClick={() => setIsSearchInputFocused(true)} className="btn btn-warning btn-lg">Click here to Search</button>
            </p>
        </div>
      </div>
    );
